...
DOCKER_OPTS+=("--name=pxl_jazzy_vnc")
DOCKER_OPTS+=("-p" "5901:5901")
DOCKER_OPTS+=("--hostname=pxl_jazzy_vnc")

# DOCKER_OPTS+=("--volume=/tmp/.X11-unix:/tmp/.X11-unix")
DOCKER_OPTS+=("-v" "`pwd`/../Commands/bin:/home/tigervnc/bin")
DOCKER_OPTS+=("-v" "`pwd`/../ExampleCode:/home/tigervnc/ExampleCode")
DOCKER_OPTS+=("-v" "`pwd`/../Data:/home/tigervnc/Data")
DOCKER_OPTS+=("-v" "`pwd`/../Projects:/home/tigervnc/Projects")
...
DOCKER_OPTS+=("pxl_ros2_jazzy_vnc:latest")
