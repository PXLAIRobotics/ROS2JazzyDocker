...
def main():
    ...
    threshold1 = 127
    threshold2 = 255
    retval, threshold = cv2.threshold(gray, threshold1, threshold2, cv2.THRESH_BINARY)
    cv2.imshow("Threshold (127,255)", threshold)
    cv2.waitKey()
    ...
    threshold2 = 255
    retval, threshold = cv2.threshold(gray, threshold1, threshold2, cv2.THRESH_BINARY)
    cv2.imshow("Blur (5,5) Threshold (117,255)", threshold)
    cv2.waitKey()
