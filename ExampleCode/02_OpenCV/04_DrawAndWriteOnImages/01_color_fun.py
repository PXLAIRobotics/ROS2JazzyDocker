...
def main():
    ...
    # An image whose data matrix has class uint8 is called an 8-bit image.
    ...
    # Ugly fact: cv2.FILLED is the value -1. Online you'll see -1 being used.
    # But please do not use -1. It's ugly. Always use the provided constants!
    cv2.imshow("image", image)
    cv2.waitKey(0)
